...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity) {
        ...
        int entityLeftWorldX = entity.worldX + entity.solidAera.x;
        int entityRightWorldX = entity.worldX + entity.solidAera.x + entity.solidAera.width;
        int entityTopWorldY = entity.worldY + entity.solidAera.y;
        int entityBottomWorldY = entity.worldY + entity.solidAera.y + entity.solidAera.height;
